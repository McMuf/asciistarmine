...
**UX pass** — a title screen and a short, skippable tutorial now run before
the game starts (no more dropping straight into a wall of text), the opening
scene is split into shorter beats, and a looping ASCII asteroid field drifts
diagonally behind everything on a canvas layer. Em dashes were swept out of
all game text and docs.
